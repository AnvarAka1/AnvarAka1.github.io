...
function emptiness(){
    if($(window).width() < $(window).height()){
        $('.h-header').addClass('empty-header');
        $('.scroll').addClass('empty-scroll');
        $('.s-offer').addClass('empty-offer');
    }
    else{
        $('.h-header').removeClass('empty-header');
        $('.scroll').removeClass('empty-scroll');
        $('.s-offer').removeClass('empty-offer');
    }
}
function carousel(){
        $(".owl-one").owlCarousel({
...
function movingToCenter(){
    $('.s-pricing').find('.pricing-block').mouseenter(function(){
        $(this).addClass('move-block');
    }).mouseleave(function(){
        $(this).removeClass('move-block');
    });
     ...
     */
        jQuery('img.svg').each(function(){
            ...
            jQuery.get(imgURL, function(data) {
                ...
                if(typeof imgV !== 'indefined'){
                   $svg.attr("viewBox", imgV);
                }
